...
​​1. 环境准备​​
若使用​​Anaconda​​：
# 创建并激活Python 3.9.13环境  
conda create -n dynamic_website python=3.9.13  
conda activate dynamic_website  
若使用​​原生Python​​：
确保已安装Python 3.9.13，并通过pip升级至最新版：
pip install --upgrade pip  
​​2. 依赖安装​​
​​推荐方式（Anaconda用户）​​：
本项目已提供requirements.txt，但为避免环境冲突，​​仅需额外安装django-admin-interface​​：
pip install django-admin-interface==0.30.0  
​​通用方式（所有用户）​​：
若需完整依赖（不推荐，可能因路径问题报错）：
